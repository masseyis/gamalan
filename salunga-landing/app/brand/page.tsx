    ...
    <div className="min-h-screen bg-salunga-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-salunga-heading font-bold text-salunga-fg mb-4">
            Salunga Brand System
          </h1>
          <p className="text-xl text-salunga-fg-secondary max-w-3xl mx-auto">
            A comprehensive design system for Salunga, the AI-enhanced agile project management
            tool. This preview showcases our brand assets, color palette, and UI components.
          </p>
        </div>

        {/* Logo Section */}
        <section className="mb-16">
          <h2 className="text-2xl font-salunga-heading font-semibold text-salunga-fg mb-8">
            Logo Assets
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-salunga-bg-secondary p-6 rounded-salunga-xl border border-salunga-border">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-salunga-heading font-bold text-salunga-fg">
                  Heading 1
                </h1>
                <h2 className="text-2xl font-salunga-heading font-semibold text-salunga-fg">
                  Heading 2
                </h2>
                <h3 className="text-xl font-salunga-heading font-medium text-salunga-fg">
                  Heading 3
                </h3>
                <h4 className="text-lg font-salunga-heading font-medium text-salunga-fg">
                  Heading 4
                </h4>
              </div>
            </div>
            ...
            <div className="bg-salunga-bg-secondary p-6 rounded-salunga-xl border border-salunga-border">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-salunga-fg-secondary">
                  Small text for secondary information
                </p>
                <p className="text-xs text-salunga-fg-muted">
        ...
        <section className="mt-16 bg-salunga-bg-secondary p-8 rounded-salunga-xl border border-salunga-border">
          <h2 className="text-2xl font-salunga-heading font-semibold text-salunga-fg mb-4">
            Accessibility
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-salunga-heading font-medium text-salunga-fg mb-3">
                Color Contrast
              </h3>
