...
export function SalungaButton({
  ...
  const variants = {
    ...
    ghost:
      'hover:bg-salunga-bg-muted text-salunga-fg-secondary hover:text-salunga-fg focus:ring-salunga-primary',
    accent:
...
export function ButtonShowcase() {
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-salunga-heading font-semibold text-salunga-fg">
        Button Variants
      </h3>
