      ...
      <div className="text-center space-y-8 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">Create, organize, and track user stories with AI-powered assistance and automated readiness validation.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Intelligent Prompts</h3>
            <p className="text-gray-600">Generate contextual prompts for development tasks with our AI-powered prompt builder.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Seamless Integration</h3>
            <p className="text-gray-600">Connect your development workflow with GitHub integration and automated CI/CD insights.</p>
          </div>
        </div>
      </div>
    </div>
