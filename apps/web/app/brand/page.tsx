          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  As a user, I want to manage my tasks efficiently so that I can deliver value to customers.
                </p>
                <div className="flex justify-between items-center">
                  <Badge variant="default" className="bg-[#22c55e] text-white">Ready</Badge>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex justify-between items-center">
                  <Badge variant="secondary" className="bg-[#f59e0b] text-white">In Progress</Badge>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex justify-between items-center">
                  <Badge variant="destructive" className="bg-[#ef4444] text-white">High Priority</Badge>
              ...
              <CardContent className="space-y-4">
                <Card>
                  <CardContent className="p-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Configure automated deployment</p>
                    <Badge variant="outline" className="mt-2">Enhancement</Badge>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-3">
                    <h5 className="font-medium text-sm">User Authentication</h5>
                    <p className="text-xs text-muted-foreground mt-1">Implement login/logout functionality</p>
              ...
              <CardContent className="space-y-4">
                <Card>
                  <CardContent className="p-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Creating responsive dashboard</p>
              ...
              <CardContent className="space-y-4">
                <Card>
                  <CardContent className="p-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Initial project configuration</p>
